...
const SelectLan = ({ dark }) => {
    ...
    return (
        <div className='flex justify-center items-center '>
            <div>
                {
                    dark ? <img quality={100} src='/images/dark-world.png' layout='raw' className='min-w-[16px] w-[16px]' width={700} height={400} alt='icon world'></img> : <img quality={100} src='/images/white-world.png' layout='raw' className='min-w-[16px] w-[16px]' width={700} height={400} alt='icon world'></img>
                }
            </div>
