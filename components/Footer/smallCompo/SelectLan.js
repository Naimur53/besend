...
const SelectLan = ({ dark }) => {
    ...
    return (
        <div className='flex justify-center items-center '>
            <div>
                {
                    dark ? <Image src='/images/dark-world.png' layout='raw' className='min-w-[16px] w-[16px]' width={16} height={16} alt='icon world'></Image> : <Image src='/images/white-world.png' layout='raw' className='min-w-[16px] w-[16px]' width={16} height={16} alt='icon world'></Image>
                }
            </div>
